...
public interface UsersRepository extends JpaRepository<Users, Integer> {
    ...
    @Query(value = "select user_id, first_name, last_name, email, phone_number as phone, ssn as SSN, position as role, phone_number as phone, address from users where first_name != '' and user_id != 27 and email != '' order by user_id", nativeQuery = true)
