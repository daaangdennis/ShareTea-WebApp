...
public class MainController {
    ...
    /**
     * API Route to delete traces of the user from the database as well as Auth0 provider
     ...
     * @return JSON Object containing user's completed and pending orders and their full details
     ...
     * 
     * @param request HTTP request containing the user's authorization access token
     * @return JSON Object containing all of the user's favorite products and their customization
     * @throws URISyntaxException
     * @throws IOException
     * @throws InterruptedException
     */
     ...
     * 
     * @param request HTTP request containing the user's authorization access token
     * @param orderProductID order_product_id which identifies favorite product in the database
     * @throws URISyntaxException
     * @throws IOException
     * @throws InterruptedException
     */
    @PostMapping("/favorites/delete")
    public void deleteFavorite(HttpServletRequest request, @RequestParam Integer orderProductID) throws URISyntaxException, IOException, InterruptedException{
    ...
    /**
     * API Route for cashier to add an order. Either both first name and last name are passed, or only the user's email
    ...
    /**
     * 
     * @return JSON Object containing both product and toppings and their full details 
     */
     ...
     * @return JSON object with products and their details that match their weather with the user's temperature
     */
    ...
    /**
     * Delete category from database and move products with that category to "Others"
