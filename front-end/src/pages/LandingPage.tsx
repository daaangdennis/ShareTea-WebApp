        ...
        <div className="row py-lg-5">
          <div className="col-lg-6 col-md-8 mx-auto">
            ...
            <p className="lead text-body-secondary">
              Sharetea serves delicious bubble tea globally. Established in 1992
              in Taiwan, we strive to create high quality tea drinks with our
              fresh ingredients and bring the best to you!
            </p>
            <p>
